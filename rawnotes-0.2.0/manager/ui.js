export const renderCollectors = (
  ...
  collectors.forEach((collector) => {
    ...
    if (selectionMode && actions?.onDelete) {
      ...
      deleteBtn.replaceChildren(...new DOMParser().parseFromString(`
...
export const renderItems = (
  ...
  items.forEach((item) => {
    ...
    if (item.shareUrl) {
      ...
      shareIcon.replaceChildren(...new DOMParser().parseFromString(`
    ...
    if (actions?.onDelete || actions?.onAddCollector) {
      ...
      if (actions?.onDelete) {
        ...
        iconSpan.replaceChildren(...new DOMParser().parseFromString(`
